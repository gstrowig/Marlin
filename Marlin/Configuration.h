...
#define STRING_CONFIG_H_AUTHOR "(Greg Strowig, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bugfix 20210711_1800"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.30, -8.90, -3.50 }
